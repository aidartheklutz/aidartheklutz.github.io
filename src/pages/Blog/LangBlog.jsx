  ...
  RU: {
    ...
    titles: {
      ctf: [
        ...
        "Как я захотел освоить основы кибербезопасности всего за четыре дня и победить в CTF.",
      ],
      historyProject: [
        "Мой огромный проект по истории",
        "Я попытался сделать небольшой проект по истории и... случайно сделал большой.",
      ],
      bugTerm: [
      ...
      mbti: [
        ...
        "Четыре буквы стали новым гороскопом для миллионов людей, но простые ярлыки личности могут быть обманчивыми.",
      ],
      doom: [
