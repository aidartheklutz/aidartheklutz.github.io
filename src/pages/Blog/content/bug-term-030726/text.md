Bugs are everywhere. Games, apps, scripts, operating systems, web browsers, databases, video streaming platforms, banking systems, and, of course, this website -- in any of these you can run into a few flaws. But have you ever wondered how "bugs" got their name?
...
The term "bug" appeared in Edison's notebooks in 1876 and after that he used it fairly often:
...
Writer and engineer Thomas Sloane formalized Edison's terminology in his 1892 _[Standard Electrical Dictionary](https://www.gutenberg.org/ebooks/26535)_. He described a "bug" as any defect or malfunction in the wiring or operation of electrical equipment, while a "bug trap" was a setup made specifically to fix or prevent such issues. Both terms were said to have originated in quadruplex telegraphy. Later, Isaac Funk's and Francis March's _[Standard Dictionary of the English Language](https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://archive.org/details/standarddictiona02funk_0&ved=2ahUKEwikk_7ClbaVAxXj0QIHHcQ2AYoQFnoECB0QAQ&usg=AOvVaw1hJEiX2cAlyrz9JcLkXyNn)_ (1895) broadened the term: they defined a "bug" as a fault in the operation of a quadruplex system or any electrical device.

After Edison, the term was adopted by other members of the electrical community. Engineers would make frequent references to Edison's bug trap. In 1888, engineer William Maver Jr. noted that those working with the quadruplex telegraph were "aware that there is tendency in its operation termed, not very elegantly perhaps, the ‘bug.' It was first so called by Edison".
...
I am very excited because this is my first article (blog post) that covers a historic event rather than a personal experience. It turned out pretty short, but more interesting stories are coming in the future.
