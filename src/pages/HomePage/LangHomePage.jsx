...
export const LANG = {
  EN: {
    ...
    description: (
      <p className="blue-link">
        ...
        electronics engineer. Here you can learn a little{" "}
  ...
  RU: {
    ...
    description: (
      <p className="blue-link">
        Я студент колледжа из Кыргызстана. Здесь вы можете узнать немного{" "}
        <NavLink to="/aboutme">обо мне</NavLink>, читать мой{" "}
        <NavLink to="/blog">блог</NavLink>, взглянуть на мои{" "}
